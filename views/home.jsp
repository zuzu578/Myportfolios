        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
         ...
         <c:if test="${logout!='Y'}">
      	 <li class="nav-item"><a href="/login">login</a></li>
                  ...
                  <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://localhost:8181/practice/login">로그인</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://localhost:8181/practice/Signup">회원가입</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://localhost:8181/practice/myInfo">마이페이지</a></li>
                        </ul>
                        
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://localhost:8181/practice/Aboutus">About us</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">그림</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://localhost:8181/practice/board">게시판</a></li>
