...
<div class="nav-items2"><a href="">게시판</a> </div>
   ...
   <button type="button" class="btn btn-primary"><a href="http://localhost:8181/practice/boardnew">글작성하기</a></button>
         <button type="button" class="btn btn-info"><a href="http://localhost:8181/practice/login">로그인 하러가기</a></button>
          <button type="button" class="btn btn-danger"><a href="http://localhost:8181/practice/Signup">계정이 없으신가요?</a></button>
