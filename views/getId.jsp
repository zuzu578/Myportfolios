...
<div class="nav-items2"><a href="http://localhost:8181/practice/Aboutus">About us</a> </div>
...
<div class="input-group mb-3">
  <input type="text" class="form-control" id="getid" name="getid" placeholder="your id" aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="buttons">
